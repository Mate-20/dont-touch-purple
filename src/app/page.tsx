...
export default function Home() {
  ...
  useEffect(()=>{
    if(isIntroGoingOn == false){
      window.localStorage.getItem("howToPlay") == "true" ? setHowToPlay(false) : setHowToPlay(true);
    }
  },[isIntroGoingOn])
    ...
    <>
      {isIntroGoingOn ? <Intro setIntro={setIsIntroGoingOn} /> :
        <div className="bg-[#121212] h-screen w-screen flex flex-col items-center gap-5 p-4 relative">
          ...
          {howToPlay &&
            <GameRules setHowToPlay={setHowToPlay} />}
          {/* Game Over Modal */}
          {gameOver &&
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="rounded-full border border-purple-500 flex items-center justify-center text-sm w-10 h-10"
